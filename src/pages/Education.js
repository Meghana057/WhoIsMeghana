          ...
          <div className="section-card" style={{ cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
              <img
                ...
                style={{ width: "60px", height: "60px" }}
              />
              <h3 style={{ margin: 0 }}>Visvesvaraya Technological University</h3>
            </div>
            <p style={{ marginTop: "15px" }}>
              ...
              <br />
              <strong>Courses:</strong> Data Structures, Operating Systems, Database Management Systems, Artificial Intelligence, Machine Learning, Object Oriented Design & Development
            </p>
          </div>
        </a>
